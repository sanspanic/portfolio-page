...
const WritingSection = () => {
  ...
  return (
    <div className="flex-grow font-monocut px-3 relative">
      <h1 className="typewriter-text-2 font-roboto font-bold text-2xl text-center py-10">
        Writing.
      </h1>
      ...
      <p className="max-w-prose mx-auto">
        ...
        myself contributing to the body of literature in the hope someone out
        there might find it useful.
      </p>
      <Writing width="400" className="mx-auto -mt-10" />
